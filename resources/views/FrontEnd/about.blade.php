...
background-image: url("{{url('/public/images/EMR.jpg')}}");
...
background-image: url("{{url('/public/images/medication.jpg')}}");
background-size: cover;
-webkit-background-size: cover;
-moz-background-size: cover;
-o-background-size: cover;
...
background-image: url("{{url('/public/images/about-us-video-consultation.jpg')}}");
background-size: cover;
-webkit-background-size: cover;
-moz-background-size: cover;
-o-background-size: cover;
...
.wthree_services_bottom_left_grid img {
min-height: 270px;
max-height: 270px;
}
span.about-circle{
...
<div class="services-bottom">
    ...
    <div class="col-md-7 wthree_services_bottom_left">
        ...
        <div class="wthree_services_bottom_left_grid">
            ...
            <div class="col-md-6 w3_agileits_services_bottom_l_grid">
                <div class="agile_services_bottom_l_grid1">
                    <img src="{{asset('images/about-video-consultation.jpg')}}" alt=" " class="img-responsive" />
                    <div class="w3_service_bottom_grid_pos">
                        <h3>Quality Care</h3>
                    </div>
                </div>
